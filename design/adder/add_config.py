...
class AdderConfig(abc.ABC):
    """
        Base class for adder configuration
    """
    ...
    @abc.abstractmethod
    def generate_verilog(self, module_name: str = "AdderConfig") -> str:
        """
            Generate verilog code for the adder
        """
        raise NotImplementedError
    

class DefaultAdderConfig(AdderConfig):
    """
        Default Adder Configuration
    """
...
""" % (module_name, self.N-1, self.N-1, self.N-1)
        
        return codes


class PPAdderConfig(AdderConfig):
    """
        Parallel Prefix Adder (PPAdder) Configuration
    """
    ...
    def generate_verilog(self, module_name: str = 'PPAdder') -> str:
        """
