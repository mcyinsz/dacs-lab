...
from design.multiplier.mult_utils import LegalizationError, InvalidActionError

class CompTreeStageViewLegalizer():
    """
        Quickly legalize design rule violation of a stage array
    """
    ...
    def __call__(self, max_trial=1000, max_repeat=5) -> CompTreeStageView:
        """
        ...
        return CompTreeStageView(self.stage_array, self.pp_gen)
